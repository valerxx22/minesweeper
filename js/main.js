function runGame() {
    var tableBoard = parseInt(document.forms["myForm"]["table"].value);
    var mineNumb = parseInt(document.forms["myForm"]["mineNumb"].value);

    var totalCell = parseInt(tableBoard * tableBoard);

    var gameOver = false;

    var cellValues = fillCells(mineNumb, totalCell);
    //window.cellValues = cellValues;
    var createTable = createTable;
    var countNeighboor = countNeighboor;
    ...
    var Stopwatch = (function (resetInterval) {
        var s, resetInterval;
        var start = function () {
    ...
    function createTable(tableParam, cellValues) {
